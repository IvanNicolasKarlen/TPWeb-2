...
if(isset($_POST["publicar"])) {
    ...
    if ($row <> 0) {
        ...
        $sql = "INSERT INTO producto(nombre,estado,precio,formasdepago,envio,marca,stock,telefono,whatsapp,genero,descripcion,imgprincipal,modelo1,modelo2,modelo3,email)
				values('$nombre','$estado',$precio,'$formas', $envio, '$marca',$stock,$telefono,$whatsapp,'$genero','$descripcion','$imgprincipal','$segunda','$tercera','$cuarta','$email')";
